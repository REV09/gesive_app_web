...
class ReportsAjustadorPage extends StatefulWidget {
  String token;
  String sesion;
  String user;
  ReportsAjustadorPage(
      {required this.token, required this.sesion, required this.user});

  static const routeName = 'ajustadorReports';
  _ReportsAjustadorPage createState() => _ReportsAjustadorPage();
}

class _ReportsAjustadorPage extends State<ReportsAjustadorPage> {
  String titlePage = "Reportes pendientes";
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Expanded(
                child: FutureBuilder(
                  future: servicesRestReporte.reportesAjustador(widget.user, widget.token),
